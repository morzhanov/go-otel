...
func (x *ProcessPaymentMessage) Reset() {
	*x = ProcessPaymentMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProcessPaymentMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcessPaymentMessage) ProtoMessage() {}

func (x *ProcessPaymentMessage) ProtoReflect() protoreflect.Message {
	mi := &file_payment_payment_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcessPaymentMessage.ProtoReflect.Descriptor instead.
func (*ProcessPaymentMessage) Descriptor() ([]byte, []int) {
	return file_payment_payment_proto_rawDescGZIP(), []int{2}
}

func (x *ProcessPaymentMessage) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
func (x *ProcessPaymentMessage) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ProcessPaymentMessage) GetAmount() int32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *ProcessPaymentMessage) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_payment_payment_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x32, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49,
	...
	0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x76, 0x0a, 0x15, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x19,
	...
	0x07, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x4b, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1e, 0x2e, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x73, 0x73,
	...
	0x2d, 0x6f, 0x74, 0x65, 0x6c, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70,
...
var file_payment_payment_proto_goTypes = []interface{}{
	...
	(*GetPaymentInfoRequest)(nil), // 1: payment.GetPaymentInfoRequest
	(*ProcessPaymentMessage)(nil), // 2: payment.ProcessPaymentMessage
}
var file_payment_payment_proto_depIdxs = []int32{
	1, // 0: payment.Payment.GetPaymentInfo:input_type -> payment.GetPaymentInfoRequest
	0, // 1: payment.Payment.GetPaymentInfo:output_type -> payment.PaymentMessage
...
func file_payment_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_payment_payment_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProcessPaymentMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
