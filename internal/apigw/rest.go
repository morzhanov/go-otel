...
func (c *controller) handleSignup(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	if err != nil {
		c.HandleRestError(ctx, err)
		return
...
func (c *controller) handleCreatePicture(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	span := c.GetSpan(ctx)
	if err != nil {
		c.HandleRestError(ctx, err)
...
func (c *controller) handleGetPictures(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	span := c.GetSpan(ctx)
	if err != nil {
		c.HandleRestError(ctx, err)
...
func (c *controller) handleGetPicture(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	picId := ctx.Param("id")
	span := c.GetSpan(ctx)
	if err != nil {
...
func (c *controller) handleDeletePicture(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	span := c.GetSpan(ctx)
	if err != nil {
		c.HandleRestError(ctx, err)
...
func (c *controller) handleGetAnalytics(ctx *gin.Context) {
	transport, err := c.sender.StringToTransport(ctx.Param("transport"))
	span := c.GetSpan(ctx)
	if err != nil {
		c.HandleRestError(ctx, err)
...
func NewController(
	...
	bc := restcontroller.NewController(
		tracer,
		logger,
		mc,
	)
